...
def get_web_search_tool(max_search_results: int):
    if SELECTED_SEARCH_ENGINE == SearchEngine.TAVILY.value:
        ...
        return LoggedDuckDuckGoSearch(name="web_search", max_results=max_search_results)  # type: ignore
...
if __name__ == "__main__":
    results = LoggedDuckDuckGoSearch(name="web_search", max_results=3, output_format="list")  # type: ignore
    print(results.name)
