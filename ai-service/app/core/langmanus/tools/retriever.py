...
class RetrieverTool(BaseTool):
    ...
    def _run(
        ...
        if not documents:
            return "No results found from the local knowledge base."  # type: ignore
        return [doc.to_dict() for doc in documents]  # type: ignore
    ...
    async def _arun(
        ...
        return self._run(keywords, run_manager.get_sync())  # type: ignore
...
if __name__ == "__main__":
    ...
    print(retriever_tool.name)  # type: ignore
    print(retriever_tool.description)  # type: ignore
    print(retriever_tool.args)  # type: ignore
    print(retriever_tool.invoke("三打白骨精"))  # type: ignore
