...
from langchain_community.utilities.tavily_search import TavilySearchAPIWrapper as OriginalTavilySearchAPIWrapper
...
if __name__ == "__main__":
    wrapper = EnhancedTavilySearchAPIWrapper()  # type: ignore
