...
class UpdateTeamRequest(TeamBase, BaseRequest):
    name: str | None = Field(
        None, description="Name of the team, must be 1-64 characters long and can only contain alphanumeric characters, underscores, and hyphens."
    )
    description: str | None = Field(None, description="Description of the team.")
    icon: str | None = Field(None, description="Icon of the team.")
...
class TeamResponse(TeamBase, BaseResponse):
    id: str
    user_id: str | None = Field(None, description="ID of the user who owns the team.")
