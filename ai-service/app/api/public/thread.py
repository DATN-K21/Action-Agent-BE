...
@router.get("/{user_id}/get-all", summary="Get threads of a user.", response_model=ResponseWrapper[GetListThreadsResponse])
...
@router.get("/{user_id}/{thread_id}/history/get-all", summary="Get history messages.", response_model=ResponseWrapper[GetHistoryResponse])
async def get_history_messages(
    ...
    response = await thread_service.get_history_messages(user_id, thread_id, paging)
    return response.to_response()
...
async def upload_files(
    ...
    response = await thread_service.upload_file_to_thread(user_id, thread_id, file)
    return response.to_response()


@router.post("/{user_id}/{thread_id}/generate-title", summary="Generate the title", response_model=ResponseWrapper[GetThreadResponse])
async def generate_title(
    ...
    response = await thread_service.generate_title(user_id, thread_id)
    return response.to_response()
