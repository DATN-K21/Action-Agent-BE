...
def get_dynamic_few_shot_gmail_prompt(user_input: str):
    ...
    create_draft_email_examples = [
        ...
        [
            ...
            ToolMessage('{"draftId": "d123456", "message": "Draft created successfully."}', tool_call_id="1"),
            AIMessage("I have created a draft email to Alice with the subject 'Project Update.'", name="example_assistant"),
        ],
        ...
        [
            ...
            ToolMessage('{"draftId": "d789012", "message": "Draft created successfully."}', tool_call_id="2"),
            AIMessage("I have created a draft email to Bob and Charlie with the subject 'Team Meeting.'",
                      name="example_assistant"),
        ],
        ...
        [
            ...
            ToolMessage('{"draftId": "d345678", "message": "Draft created successfully."}', tool_call_id="3"),
            AIMessage(
    ...
    send_mail_examples = [
        ...
        [
            ...
            AIMessage("The email to Alice with the subject 'Reminder' has been sent successfully.",
                      name="example_assistant"),
        ],
        ...
        [
            ...
            AIMessage("The email to Bob and Charlie with the subject 'Meeting Update' has been sent successfully.",
                      name="example_assistant"),
        ],
    ...
    search_email_examples =[
        ...
        [
            HumanMessage("Search for emails with the subject 'Project Update'.", name="example_user"),
            AIMessage(
                "",
                name="example_assistant",
                tool_calls=[
            ...
            ToolMessage('[{"messageId": "msg12345", "snippet": "Here is the project update you requested."}]',
                        tool_call_id="1"),
            AIMessage(
        ...
        ToolMessage('[{"messageId": "msg67890", "snippet": "Hi, just checking in about our meeting tomorrow."}]',
                    tool_call_id="2"),
        AIMessage("I found an email from Alice with snippet: 'Hi, just checking in about our meeting tomorrow.'",
                  name="example_assistant"),
        ],
        ...
        [
            ...
            ToolMessage('[{"messageId": "msg34567", "snippet": "Reminder: Team meeting scheduled for Friday."}]',
                        tool_call_id="3"),
            AIMessage("I found an email sent in the last week with snippet: 'Reminder: Team meeting scheduled for Friday.'",
                      name="example_assistant")
        ],
        ...
        [
            ...
            ToolMessage('[{"messageId": "msg98765", "snippet": "Please find the attached document for your review."}]',
                        tool_call_id="4"),
            AIMessage(
    ...
    get_message_examples =[
        ...
        [
            HumanMessage("Retrieve the details of the email with the message ID 'msg12345'.", name="example_user"),
            AIMessage(
                "",
                name="example_assistant",
                tool_calls=[
        ...
        [
            HumanMessage("Fetch the details of the email with the message ID 'msg67890'.", name="example_user"),
            AIMessage(
                "",
                name="example_assistant",
                tool_calls=[
        ...
        [
            HumanMessage("Get the details of the email with the message ID 'msg99999'.", name="example_user"),
            AIMessage(
                "",
                name="example_assistant",
                tool_calls=[
    ...
    get_thread_examples = [
        ...
        [
            HumanMessage("Retrieve the full thread of the email conversation with the subject 'Project Discussion'.",
                         name="example_user"),
            AIMessage(
                "",
                name="example_assistant",
                tool_calls=[
                    {
                        "name": "GmailGetThread",
                        "args": {
                            "query": "subject:Project Discussion"
                        },
                        "id": "1"
                    }
                ],
        ...
        [
            HumanMessage("Retrieve the thread of emails with the query 'newer_than:30d label:inbox'.", name="example_user"),
            AIMessage(
                "",
                name="example_assistant",
                tool_calls=[
                    {
                        "name": "GmailGetThread",
                        "args": {
                            "query": "newer_than:30d label:inbox"
                        },
                        "id": "3"
                    }
                ],
            ...
            AIMessage("No email threads were found matching the query 'newer_than:30d label:inbox'.",
                      name="example_assistant")
        ]
    ]

    #Todo: Implement dynamic few-shot learning for Gmail
    examples = [*create_draft_email_examples[0],
